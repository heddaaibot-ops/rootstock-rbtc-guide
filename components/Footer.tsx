    ...
    <footer className="bg-rsk-text-dark text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h4 className="font-bold text-base mb-4 text-rsk-orange">资源</h4>
          ...
          <div>
            <h4 className="font-bold text-base mb-4 text-rsk-orange">社区</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="font-bold text-base mb-4 text-rsk-orange">关于</h4>
